  ...
  return (
    <>
      <div className="visually-hidden">
        BizConsult — онлайн-сервис профессиональных бизнес-консультаций.
        Мы помогаем предпринимателям и компаниям развивать бизнес,
        выстраивать стратегию, повышать прибыль и оптимизировать процессы.
        Консультации по маркетингу, финансам, управлению и масштабированию бизнеса.
      </div>
